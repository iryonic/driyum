    ...
    <div class="bg-emerald-800 text-white py-2 px-4">
        <div class="container mx-auto flex justify-between items-center">
            ...
            <div class="text-sm sm:hidden flex items-center space-x-4">
                <a href="tel:<?php echo get_setting('store_phone'); ?>" class="hover:text-emerald-300">
                    <i class="fas fa-phone"></i>
                </a>
                <a href="mailto:<?php echo get_setting('store_email'); ?>" class="hover:text-emerald-300">
                    <i class="fas fa-envelope"></i>
                </a>
            </div>

            <div class="text-sm">
                <a href="<?php echo SITE_URL; ?>/contact.php" class="hover:text-emerald-300 mr-4">
                    <i class="fas fa-headset mr-1"></i> Support
                </a>
                <a href="<?php echo SITE_URL; ?>/faq.php" class="hover:text-emerald-300">
            ...
            <div class="flex justify-between items-center">
                ...
                <div class="flex items-center">
                    <a href="<?php echo SITE_URL; ?>" class="flex items-center">
                        ...
                        <span class="text-2xl font-bold text-emerald-700"><?php echo SITE_NAME; ?></span>
                    </a>
                </div>
                ...
                <div class="hidden md:block w-1/3">
                    <form action="<?php echo SITE_URL; ?>/shop.php" method="GET" class="relative">
                        ...
                        <button type="submit" class="absolute right-3 top-2.5 text-gray-400 hover:text-emerald-600">
                ...
                <div class="flex items-center space-x-6">
                    <!-- Cart -->
                        <a href="<?php echo SITE_URL; ?>/cart.php" class="relative text-gray-700 hover:text-emerald-600">
                    ...
                    <?php if (is_logged_in()): ?>
                        <div class="relative group">
                            ...
                            <div class="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg py-2 z-10 hidden group-hover:block hover:block">
                                <?php if (is_user()): ?>
                                    <a href="<?php echo SITE_URL; ?>/dashboard/" class="block px-4 py-2 text-gray-800 hover:bg-stone-50 hover:text-emerald-700">
                                        <i class="fas fa-tachometer-alt mr-2"></i> Dashboard
                                    </a>
                                    <a href="<?php echo SITE_URL; ?>/dashboard/orders.php" class="block px-4 py-2 text-gray-800 hover:bg-stone-50 hover:text-emerald-700">
                                        <i class="fas fa-shopping-bag mr-2"></i> Orders
                                    </a>
                                    <a href="<?php echo SITE_URL; ?>/dashboard/wishlist.php" class="block px-4 py-2 text-gray-800 hover:bg-stone-50 hover:text-emerald-700">
                                        <i class="fas fa-heart mr-2"></i> Wishlist
                                    </a>
                                    <a href="<?php echo SITE_URL; ?>/dashboard/profile.php" class="block px-4 py-2 text-gray-800 hover:bg-stone-50 hover:text-emerald-700">
                                ...
                                <?php if (is_admin()): ?>
                                    <a href="<?php echo ADMIN_URL; ?>/dashboard.php" class="block px-4 py-2 text-gray-800 hover:bg-stone-50 hover:text-emerald-700">
                    ...
                    <?php else: ?>
                        <div class="flex items-center space-x-4">
                            <a href="<?php echo SITE_URL; ?>/login.php" class="text-gray-700 hover:text-emerald-600">
                                <i class="fas fa-sign-in-alt mr-1"></i> Login
                            </a>
                            <a href="<?php echo SITE_URL; ?>/register.php" class="bg-emerald-600 text-white px-4 py-2 rounded-lg hover:bg-emerald-700 transition">
            ...
            <div class="container mx-auto px-4">
                <div class="flex justify-between items-center">
                    ...
                    <div class="flex items-center space-x-6 py-3">
                        <a href="<?php echo SITE_URL; ?>" class="hover:bg-emerald-800 px-3 py-2 rounded transition <?php echo basename($_SERVER['PHP_SELF']) == 'index.php' ? 'bg-emerald-800' : ''; ?>">
                            <i class="fas fa-home mr-2"></i> Home
                        </a>
                        <a href="<?php echo SITE_URL; ?>/shop.php" class="hover:bg-emerald-800 px-3 py-2 rounded transition <?php echo basename($_SERVER['PHP_SELF']) == 'shop.php' ? 'bg-emerald-800' : ''; ?>">
                                ...
                                <div class="absolute left-0 mt-1 w-48 bg-white text-gray-800 rounded-lg shadow-lg py-2 z-10 hidden group-hover:block hover:block">
                                    <?php foreach ($categories as $category): ?>
                                        <a href="<?php echo SITE_URL; ?>/shop.php?category=<?php echo $category['slug']; ?>" 
                                           class="block px-4 py-2 hover:bg-stone-50 hover:text-emerald-700">
                        ...
                        <a href="<?php echo SITE_URL; ?>/about.php" class="hover:bg-emerald-800 px-3 py-2 rounded transition <?php echo basename($_SERVER['PHP_SELF']) == 'about.php' ? 'bg-emerald-800' : ''; ?>">
                            <i class="fas fa-info-circle mr-2"></i> About
                        </a>
                        <a href="<?php echo SITE_URL; ?>/contact.php" class="hover:bg-emerald-800 px-3 py-2 rounded transition <?php echo basename($_SERVER['PHP_SELF']) == 'contact.php' ? 'bg-emerald-800' : ''; ?>">
                    ...
                    <div class="pt-2 border-t">
                        <a href="<?php echo SITE_URL; ?>/cart.php" class="flex items-center px-3 py-2 hover:bg-gray-50">
                            ...
                            <?php $cart_count_mobile = get_cart_count(); if ($cart_count_mobile > 0): ?>
                                <span class="ml-auto bg-emerald-600 text-white text-xs rounded-full h-5 w-5 flex items-center justify-center"><?php echo $cart_count_mobile; ?></span>
                            <?php endif; ?>
                        </a>
                    </div>

                    <div class="pt-2 border-t">
                        <span class="text-xs text-emerald-600">Free Shipping on orders above ₹<?php echo get_setting('free_shipping_amount'); ?></span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container mx-auto px-4">
                <nav class="flex" aria-label="Breadcrumb">
                    <ol class="flex items-center space-x-2 text-sm">
                        <li>
                            <a href="<?php echo SITE_URL; ?>" class="text-gray-500 hover:text-emerald-600">
                        ...
                        <?php foreach ($breadcrumbs as $crumb): ?>
                            <li class="flex items-center">
                                ...
                                <?php if (isset($crumb['url'])): ?>
                                    <a href="<?php echo $crumb['url']; ?>" class="text-gray-500 hover:text-emerald-600">
